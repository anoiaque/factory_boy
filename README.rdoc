...
== Specification of  the class of the fixure definition 
...
For refactoring tests which used database before(with factory_girl or other) with plants, require 'plant' in files tests step by step, cause plant stubs AR#find.
