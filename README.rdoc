...
<b> Note : Version 2.0.2 is compatible with ActiveRecord < 3.1 </b>

<b> Note : Version 2.0.3 is compatible with ActiveRecord >= 3.1 </b>
...
This version has been tested with ActiveRecord >= 3.0 and <= 3.1 and ruby 1.8.7 & 1.9.2
